...
LOG_FILE = "data/user_log.txt"    # НАДО СДЕЛАТЬ ПРАВКУ НА ПРОПИСКУ ДЕЙСТВУЩЕЙ ДИРЕКТОРИИ НАХОЖДЕНИЯ БОТА ВНЕСТИ ПЕРЕМЕННУЮ ДТ для формирования ежедневного лога
ADMIN_ID = 218553624
