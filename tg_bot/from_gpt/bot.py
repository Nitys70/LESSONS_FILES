...
from config import TELEGRAM_BOT_TOKEN, AUTH_PASSWORD, MAX_HISTORY_LENGTH, OPENAI_API_KEY
...
hello_message = "👋 Добро пожаловать! Я чат-бот Chat-GPT 3.5." + \
    "Cо мной ты можешь обсудить практически все темы, а так же задать интересующий тебя вопрос. " + \
    "Я очень постараюсь тебе помочь." + \
    "К сожалению, я не умею делать поиск в интернете, но, я могу помочь тебе с прогнозом погоды. " +\
